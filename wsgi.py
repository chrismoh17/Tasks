...
def initialize():
    ...
    create_semester_new(1, "", 1, 2024)
    create_semester_new(2, "", 2, 2024)
    create_course_new("COMP2611","Data Structures","6","core","1","2")
    create_course_new("INFO2613","Software Structures","5","core","1","2")
    create_course_new("MATH2250","Industrial Statistics","3","elec","2","1")
    create_course_new("INFO3613","Medium Data Analytics","3","elec","1","1")
    create_course_new("COMP3605","Data Analytics","1","elec","1","2")
    create_course_new("COMP3610","Big Data Analytics","6","elec","1","1")
    create_course_new("COMP3611","Small Data Analytics","1","elec","1","1")
    
    #createCoursesfromFile('testData/courseData.csv')
    create_program("Computer Science Major", 69, 15, 1, 1)
